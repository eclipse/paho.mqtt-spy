function replay()
{
	...
	if (messageCount == 0)
	{
		messageCount = auditReplay.readFromFile("/home/kamil/Programming/Source/mqtt-spy/mqtt-spy/src/test/resources/scripts/virtual_iot_meetup_samples/bedrooms.messages");		
		auditReplay.setSpeed(20);		
	}
