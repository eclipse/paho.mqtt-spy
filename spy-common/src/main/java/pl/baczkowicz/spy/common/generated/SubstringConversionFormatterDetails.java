    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SubstringConversionFormatterDetails) {
            final SubstringConversionFormatterDetails copy = ((SubstringConversionFormatterDetails) draftCopy);
            if (this.format!= null) {
