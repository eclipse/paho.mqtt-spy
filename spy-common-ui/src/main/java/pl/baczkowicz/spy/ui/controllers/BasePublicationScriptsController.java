...
public abstract class BasePublicationScriptsController implements Initializable, TitledPaneController
{
	/** Diagnostic logger. */
	private final static Logger logger = LoggerFactory.getLogger(BasePublicationScriptsController.class);
	...
	public void init()
	{
		...
		settingsButton = BaseViewManager.createTitleButtons(this, paneTitle, paneVisibilityManager);
	...
	public void setPaneVisibilityManager(final PaneVisibilityManager paneVisibilityManager)
	{
	...
	public BasePublicationScriptsController()
	{
		super();
	}
